...
class WPPopups_Review {
	...
	public function review() {
		...
		<div class="notice notice-info is-dismissible wppopups-review-notice">
			...
			<p>
				<a href="https://wordpress.org/support/plugin/wppopups-lite/reviews/?filter=5#new-post"
	...
	public function admin_footer( $text ) {
		...
		if ( ! empty( $current_screen->id ) && strpos( $current_screen->id, 'popups' ) !== false ) {
			$url  = 'https://wordpress.org/support/plugin/wppopups-lite/reviews/?filter=5#new-post';
			$text = sprintf(
				wp_kses(
