 ...
 *
 */
function wppopups_rules_field( $field_type, $rule_id, $group_key, $field, $popup_data, $label, $args = [], $echo = true ) {
	...
	$field_name = sprintf( '%s[%s][%s][%s]', 'rules', $group_key, $rule_id, $field );
	$value      = isset( $popup_data['rules'][ $group_key ][ $rule_id ][ $field ] ) ? $popup_data['rules'][ $group_key ][ $rule_id ][ $field ] : $default;
